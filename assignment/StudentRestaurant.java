...
public class StudentRestaurant {
    ...
    public static void initializeMenu() {
        ...
        foodItems.add("Mukimo");
        foodPrices.add(120.00);
        foodItems.add("Chapati");
        foodPrices.add(80.00);
        drinkItems.add("chai");
        drinkPrices.add(20.00);
        drinkItems.add("Maziwa");
        drinkPrices.add(100.00);
    }
    ...
    public static void displayMenu() {
        ...
        for (int i = 0; i < foodItems.size(); i++) {
            System.out.println(foodItems.get(i) + " - ksh" + foodPrices.get(i));
        }
        System.out.println("DRINKS:");
        for (int i = 0; i < drinkItems.size(); i++) {
            System.out.println(drinkItems.get(i) + " - ksh" + drinkPrices.get(i));
        }
    }
